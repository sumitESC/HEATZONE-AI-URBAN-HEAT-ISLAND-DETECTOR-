...
import { Activity, MapPin, Thermometer, Wind, Car, Leaf, ArrowRight, AlertTriangle, Construction, Zap } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <StatCard 
          ...
          icon={<Construction className="w-5 h-5 text-orange-400" />}
          delay={0.6}
        />
        <StatCard 
